# Generated by 2sc from function 'Ensure-ProfileGetFileHashCommand' (2026-08-12 23:58:08).
...
function Ensure-ProfileGetFileHashCommand {
...
if ($MyInvocation.InvocationName -ne '.') {
    & 'Ensure-ProfileGetFileHashCommand' @args
}
